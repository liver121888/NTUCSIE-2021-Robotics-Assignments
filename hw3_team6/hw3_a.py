...
path = './Assignment3/PartA/Camera_Calib/final_checkonly/*.jpg'
# Image path (with another object):
path2 = './Assignment3/PartA/Camera_Calib/final_cap/*.jpg'
# Undistort result path:
path_out = './Assignment3/PartA/Camera_Calib/result/calibresult_{}.jpg'
